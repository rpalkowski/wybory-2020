...
# ggsave(mapa_poparcie_proc_wkk, file = "poparcie_proc_wkk.png", width=6, height=6, dpi=300)
...
# ggsave(mapa_poparcie_proc_rb, file = "poparcie_proc_rb.png", width=6, height=6, dpi=300)
...
# ggsave(mapa_poparcie_proc_sz, file = "poparcie_proc_sz.png", width=6, height=6, dpi=300)
...
# ggsave(mapa_poparcie_proc_mj, file = "poparcie_proc_mj.png", width=6, height=6, dpi=300)
...
# ggsave(mapa_poparcie_proc_pt, file = "poparcie_proc_pt.png", width=6, height=6, dpi=300)
...
# ggsave(mapa_poparcie_proc_ww, file = "poparcie_proc_ww.png", width=6, height=6, dpi=300)
